...
clientes = [Cliente(1, 'Daniel Mastral', 17, '200.100.345-34', 'P.Física'),
            Cliente(2, 'Rodriguinho', 34, '200.100.345-35', 'P.Física'),
            Cliente(3, 'Monark', 51, '200.100.345-37', 'P.Jurídica'),
            Cliente(4, 'Tiaguinho', 68, '200.100.345-38', 'P.Física'),
            Cliente(5, 'Ruannito', 85, '200.100.345-39', 'P.Jurídica'),
            Cliente(6, 'Pedrinho Matador', 102, '200.100.345-40', 'P.Física'),
