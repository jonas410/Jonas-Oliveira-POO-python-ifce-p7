...
listadeclientes = [
    Cliente(1, 'jonas', 100, '4002892200', 'P. Física'),
    Cliente(2, 'Lazaro Matador', 200, '3334442220', 'P. Fisica'),
    Cliente(3, 'Will smiter', 300, '0119574231', 'P.Física')
]

listadeprodutos = [
    Produto(1, 10, 'Sabonete Líquido', 15.50),
    Produto(2, 20, 'Fone JBL', 100.00),
    Produto(3, 30, 'Moletom GAP', 250.00),
    Produto(4, 40, 'Camisa Flamengo', 200.00)
]
